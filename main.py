...
async def convert_kyro_to_your_system(target_uid, chat_id, key, iv, nickname="REHAN 1M", title_id=None):
...
def remove_from_whitelist(uid_to_remove):
    ...
    if uid_str == "7436272383":  # Your UID
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[[B][C][9B59B6]╔═══◆ WELCOME TO GUILD BOT ◆═══╗
[7F8C8D]╟──────────────────────────────╢
[FFFFFF]🎯 Status     : [2ECC71]ONLINE All time
[FFFFFF]📱 Contact    : [1ABC9C]I-G [b][c]@rehan_gaming_2.0_
[7F8C8D]╟──────────────────────────────╢
...
"""
                ...
                if senthi == True:
                    ...
                    def get_random_color(): return "_" 
                    message = """[B][C][9B59B6]╔═══◆ WELCOME TO GUILDBOT ◆═══╗
[7F8C8D]╟───────────────────────╢
[FFFFFF]🎯 Status     : [2ECC71]ONLINE 24/7
[FFFFFF]   Admin    : [1ABC9C]tt [b][c] REHAN
[7F8C8D]╟───────────────────────╢
[9B59B6]╚═══◆  ------------------------------ ◆═══╝"""
                        # In your auto-join (Old Handler) code, find this line:
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/wlremove'):
                            ...
                            # Check owner
                            if str(response.Data.uid) != "7436272383":
...
"""
                            ...
                            if str(response.Data.uid) != "7436272383":  # Replace with your actual UID
...
"""
                        ...
                        if inPuTMsG.strip() == '/wllist':
                            ...
                            # Check if owner
                            if str(response.Data.uid) != "7436272383":  # Your UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "7436272383":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {uid}"
                                    count += 1
                                    if count >= 20:
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][00BFFF]╔════════════════════╗
[FFFFFF]✨ FOLLOW INSTAGRAM 
[FFFFFF]⚡ [00E5FF] @rehan_gaming_2.0_
[AAAAAA]Thank you for your continued support
[00BFFF]╠════════════════════╣
[FFD700]⚡ Owner : [FFFFFF] REHAN 
[00FF99]✨ To Need a GUILD BOT
[00FF99]please contact us on Admin 
[FFFFFF]  YT: @rehan_gaming_2.0
[00BFFF]╚════════════════════╝
[CCCCCC]✨ Developed by [00E5FF] REHAN 
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "REHAN 1M!!", key, iv)
...
[FFFFFF]Example: /bundle devil"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "hi", "hello", "commands"):
                            ...
                            basic = """╔════════════╗
                                                       [b][c][1E90FF]🤖   B A S I C   C O M M A N D S   🤖
[FF6A00]/start        [A9A9A9]Start match
[9B59B6]1 /exit         [A9A9A9] Leave squad
[1ABC9C]2 /3            [A9A9A9]Send 3-player invite
[E84393]3 /5            [A9A9A9]Send 5-player invite
[0984E3]4 /6            [A9A9A9]Send 6-player invite
[D63031]5 ! (team code) [A9A9A9]Join squad
[6C5CE7]6 /ghost (team code) [A9A9A9]Ghost join squad
...
"""
                            ...
                            emotes = """╔══════════════╗ 
                            [b][c][1E90FF]🎭   E M O T E   C O M M A N D S   🎭
                            
[FF922B]7 /e [emote]              [A9A9A9]Send emote to yourself
[6D214F]8 /e [uid] [emote]        [A9A9A9]Send emote to player
[20BF6B]9 /e list                 [A9A9A9]Show all emotes
[A55EEA]10 /e list names           [A9A9A9]Show named emotes
╚════════════╝
"""
                            ...
                            evo = """╔═══════════════╗
                            [b][c][1E90FF]⚡   E V O L U T I O N   E M O T E S   ⚡  

[FF6F00]11 @evos                 [A9A9A9]Start evolution cycle
[C44569]12 @sevos                [A9A9A9]Stop evolution cycle
[10AC84]13 /evo [num]            [A9A9A9]Send evo emote (1-18)
[5F27CD]14 /evo [uid] [num]      [A9A9A9]Send evo emote to player
...
"""
                            ...
                            spam_cmnd = """╔═══════════════╗
                            [b][c][1E90FF]🚀   S P A M   C O M M A N D S   🚀

[FF7F50]/fast [uid] [emote]        [A9A9A9]Fast emote spam
[8E44AD15 ]/p [uid] [emote] [num]     [A9A9A9]Custom emote spam
[C0392B]16 /reject [uid]              [A9A9A9]Reject spam
[16A085]17 /reject_stop               [A9A9A9]Stop reject spam
[2980B9]18 /msg [text] [times]        [A9A9A9]Message spam
[2C3E50]19 /stop msg                  [A9A9A9]Stop message spam
[6F1E51]20 /mg [text] [repeats]       [A9A9A9]Wave message spam
╚═════════════╝"""
                            ...
                            badge_cmnd = """╔═══════════════╗
                            [b][c][1E90FF]🎯   B A D G E   C O M M A N D S   🎯

[FF9F1A]21 /v1 [uid]          [A9A9A9]Join Req Craftland Badge
[6C5CE7]22 /v2 [uid]          [A9A9A9]Join Req New V-Badge
[E17055]23 /v3 [uid]          [A9A9A9]Join Req Moderator Badge
[9B59B6]24 /v4 [uid]          [A9A9A9]Join Req Small V-Badge
[D63031]25 /v5 [uid]          [A9A9A9]Join Req Pro Badge
[1E3799]26 /spam [uid]        [A9A9A9]Spam with all badge
[C][B][FF7F50]27 /spm [uid]        [A9A9A9]Spam normal request
[C][B][FF7F50]28 /sspm             [A9A9A9]Stop spam normal request
╚══════════╝"""
                            ...
                            ad_cmnd = """╔════════════╗
                            [b][c][1E90FF]🔧   A D V A N C E D   C O M M A N D S   🔧

[FF793F]29 /inv [uid]               [A9A9A9]Send group invite
[5F27CD]30 /joinroom [id] [pass]    [A9A9A9]Join custom room
[C44569]31 /lag [team_code]         [A9A9A9]Lag attack squad
[10AC84]32 /stop lag                [A9A9A9]Stop lag attack
╚════════════╝"""
                            ...
                            info_cmnd = """╔═════════════╗
                            [b][c][1E90FF]🔍   I N F O   C O M M A N D S   🔍

[FF6B6B]33 /info [uid]             [A9A9A9]Player information
[6A89CC]34 /status [uid]           [A9A9A9]Check player status
[EB2F06]35 /gali [name]            [A9A9A9]Gali spam message
[4A69BD]36 /likes [uid]            [A9A9A9]Send 100 likes
[A65EEA]37 /ai [question]          [A9A9A9]Chat with AI
[2C2C54]38 /check (uid)            [A9A9A9]Check Ban Status
╚═════════════╝"""
                            ...
                            about = """╔══════════════╗
                            [b][1E90FF]❓   H E L P   &   A B O U T   ❓

[FF8C00]38 /help                   [A9A9A9]Show this help menu
[8E44AD]40 /admin                  [A9A9A9]Admin / contact information
[E84393]41 /quick [code] [emote] [uid]   [A9A9A9]Quick emote attack
[C][B][FF6F61]42 /play [uid] [1-414]     [A9A9A9]Play emotes without emote id's
[C][B][9B59B6]43 /bundle [name]     [A9A9A9]Show available bundle
[00FF00]44 /bundle [name] [A9A9A9]Equip Legendary Bundle
╚══════════╝"""
                            ...
                            whitelist_cmnd = """╔═══════════════╗
                            [b][1E90FF]🔐  E X T R A C O M M A N D S   🔐

[FF4757]45 noob              [A9A9A9]Show surprise 🙀
[3742FA]46 /sticker          [A9A9A9]Show sticker
[A55EEA]47 /title            [A9A9A9]Show titles
[FF6F00]48 /ig  (username)              [00CEC9]Get Instagram info
[6F1E51]49 /tt  (username)            [54A0FF]Get TikTok info
[FF9F43]50 /lv [uid]        [1ABC9C]Get player level info
╚══════════╝"""
...
[C][B][FF0000]│[00FF00]★[FF0000]│[FFFFFF]║[00BFFF]ADMIN[FFFFFF]║
[C][B][FFD700]╰[FF0000]─[FFD700]╯[FFFFFF]
[C][B][FF0000]━━━━━━━━━━━
[C][B][FFFFFF] FOLLOW   : [00BFFF]  ANY PROBLEM DM
[C][B][FFFFFF] instagram  : [00BFFF] @rehan_gaming_2.0_
[C][B][FFFFFF] UID  : [00BFFF]  7436272383
[C][B][FF0000]━━━━━━━━━━━
